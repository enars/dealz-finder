...
async function runScraper() {
  ...
  try {
    ...
    await page.goto(FORUM_URL, { waitUntil: "networkidle2", timeout: 30000 });

    // Wait for actual content (not Cloudflare challenge)
    await page.waitForSelector(".forum-post", { timeout: 15000 });
    ...
    if (lastPageLink) {
      await page.goto(lastPageLink, { waitUntil: "networkidle2", timeout: 30000 });
      await page.waitForSelector(".forum-post", { timeout: 15000 });
    }
